...
function SettingsForm() {
    ...
    return (
        <form style={{ display: "flex", flexDirection: "column", gap: "10px" }} onSubmit={(e) => handleSubmit(e, updatedUser)}>
            ...
            <button className={scss.hideBlock} onClick={LogOut} >Logout</button>
        </form>
    )
}
